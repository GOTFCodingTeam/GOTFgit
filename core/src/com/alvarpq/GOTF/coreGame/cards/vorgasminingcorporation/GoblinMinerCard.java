...
public class GoblinMinerCard extends UnitCard
{
	...
	{
		super(110116, "Goblin Miner", 1, new Element[]{Element.EARTH}, "When Goblin Miner deals damage to an idol, increase resources and Earth by 1.", owner, new UnitFactory(GoblinMiner.class));
	}
}
